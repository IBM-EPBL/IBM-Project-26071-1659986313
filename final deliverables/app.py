    ...
    if request.method == 'POST':
        ...
        if account:
            ...
            for result in results:
                  if(result["CATEGORY"] == "utensils"):
                    data[0] = result["COUNT"]
                  elif(result["CATEGORY"] == "electronics"):
                    data[1] = result["COUNT"]
                  elif(result["CATEGORY"] == "furniture"):
                    data[2] = result["COUNT"]
                  elif(result["CATEGORY"] == "books"):
                    data[3] = result["COUNT"]
                  elif(result["CATEGORY"] == "healthcare"):
                    data[4] = result["COUNT"]
                  elif(result["CATEGORY"] == "miscellenous"):
                    data[5] = result["COUNT"]
            print(data)
            return render_template('dashboard.html', msg = msg, results = data)
        else:
